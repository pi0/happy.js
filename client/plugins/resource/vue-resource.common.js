...
/**
 * Plugin for sending network requests.
 */
...
/**
 * Plugin for interacting with RESTful plugins.
 */
...
function plugin(Vue) {
  ...
  if (Vue.__vue_resource) return;
  Vue.__vue_resource = true;
